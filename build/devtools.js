...
const inspectedTabId = webextension_polyfill_1.default.devtools.inspectedWindow.tabId;
...
devtools.listen(constants_1.CREATE_DEVTOOLS_PANEL, ({ payload }) => __awaiter(void 0, void 0, void 0, function* () {
    if (isPanelCreated) {
        return;
    }
    const panel = yield webextension_polyfill_1.default.devtools.panels.create("Apollo", "logo_devtools.png", "panel.html");
    isPanelCreated = true;
