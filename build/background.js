...
webextension_polyfill_1.default.runtime.onMessage.addListener(({ message }, sender) => {
    var _a;
    if (message === constants_1.REQUEST_TAB_ID) {
        return Promise.resolve((_a = sender.tab) === null || _a === void 0 ? void 0 : _a.id);
    }
});
