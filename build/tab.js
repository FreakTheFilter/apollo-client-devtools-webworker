...
if (typeof document === "object" && document instanceof HTMLDocument) {
    ...
    script.setAttribute("src", webextension_polyfill_1.default.runtime.getURL("hook.js"));
...
function requestId() {
    return webextension_polyfill_1.default.runtime.sendMessage({ message: constants_1.REQUEST_TAB_ID });
}
